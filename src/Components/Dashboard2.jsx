    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 max-w-5xl mx-auto gap-2 mt-4 mb-10">
                ...
                <Link className="bg-[#C21292] text-white py-1 md:px-4 px-2 rounded mx-1 font-semibold text-start md:text-center text-sm md:text-md hover:bg-[#711DB0] transition-all uppercase flex justify-start md:justify-center items-center gap-1" to={'/dashboard/dp'}><MdManageAccounts />M.Account</Link>
                ...
                <Link className="bg-[#C21292] text-white py-1 md:px-4 px-2 rounded mx-1 font-semibold text-start md:text-center text-sm md:text-md hover:bg-[#711DB0] transition-all uppercase flex justify-start md:justify-center items-center gap-1" to={'/dashboard/dp'}><TiMail />massage</Link>
            </div>
            <Outlet></Outlet>
        </div>
    );
